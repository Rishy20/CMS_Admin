                    ...
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={2}  justify="center">
                            <Grid item xs={12} md={6}>
                                <Input label="Track Name" value={values.name} id="name" type="text"
                                       name="name" onChange={handleChange} placeholder="Enter track name"
                                       error={errors["name"] ? errors["name"] : ''}
                                />
                            </Grid>
                            <Grid item xs={12} md={6}>
                                <label style={formLabel}>Track Image</label>
